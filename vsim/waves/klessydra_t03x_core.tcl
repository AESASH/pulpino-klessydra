...
add wave -group Debug -color Yellow  -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/PIPE/instr_rvalid_ID_int
add wave -group Debug -color Magenta -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/PIPE/instr_rvalid_IE
...
add wave -group Debug -color Yellow       -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/harc_ID
add wave -group Debug -color Magenta      -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/harc_EXEC
...
add wave -group Debug -color Yellow       -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/pc_ID
add wave -group Debug -color Magenta      -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/pc_IE
add wave -group Debug -radix unsigned tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/RF/RS1_Addr_IE
add wave -group Debug -radix unsigned tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/RF/RS2_Addr_IE
add wave -group Debug -radix unsigned tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/RF/RD_Addr_IE
add wave -group Debug -color Yellow       -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/instr_word_ID
add wave -group Debug -color Magenta      -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Pipe/instr_word_IE
...
add wave -group PC -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Prg_Ctr/pc_wire
add wave -group PC -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Prg_Ctr/pc
add wave -group PC -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Prg_Ctr/taken_branch_addr_internal
...
add wave -group PC -radix hexadecimal tb/top_i/core_region_i/CORE/RISCV_CORE/Prg_Ctr/mepc_addr_internal
